...
This contains all the effects from Joker's Custom Roles plugin as well, including some role specific stuff as their own ability (such as Dwarfs being smaller), you can find [Joker's custom roles plugin here](https://github.com/joker-119/CustomRoles) If Joker wishes for his custom role abilities to be removed from this repo, just let me know and I will remove them.
